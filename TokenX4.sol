...
/**
 * @dev Interface for PancakeSwap Factory 
 */
...
/**
 * @dev Interface for PancakeSwap Pair 
 */
...
/**
 * @dev Interface for PancakeSwap Router V1
 */
...
/**
 * @dev Interface for PancakeSwap Router V2
 */
...
contract TOKENX5 is Context, BEP20, Ownable {
    ...
    string public constant _name = "TOKENX2";
    string public constant _symbol   = "TKX2";
    ...
    */
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
        ...
        */
         ...
         */
        swapTokensForEth(half); // <- this breaks the BNB -> MXMY swap when swap+liquify is triggered
